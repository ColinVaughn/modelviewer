 ...
 * const object = await loaders.loadAsync( 'models/monster.obj' );
 * scene.add( object );
 * ```
 *
 * @augments Loader
...
class OBJLoader extends Loader {
	 ...
	 * @return {OBJLoader} A reference to this loaders.
	 */
	...
	parse( text ) {
		...
		for ( let i = 0, l = lines.length; i < l; i ++ ) {
			...
			if ( lineFirstChar === 'v' ) {
				...
				// the line is parsed but ignored since the loaders assumes textures are defined MTL files
